...
const WIRE_DEFS = [
    { id: "WireI0_MUX4to1", relPath: "input0" },
    { id: "WireI1_MUX4to1", relPath: "input1" },
    { id: "WireI2_MUX4to1", relPath: "input2" },
    { id: "WireI3_MUX4to1", relPath: "input3" },
    { id: "WireS0_MUX4to1", relPath: "s0" },
    { id: "WireS1_MUX4to1", relPath: "s1" },
    { id: "WireS0Not_MUX4to1", relPath: "s0n" },
    { id: "WireS1Not_MUX4to1", relPath: "s1n" },
    { id: "WireAND0_MUX4to1", relPath: "ANDWire0" },
    { id: "WireAND1_MUX4to1", relPath: "ANDWire1" },
    { id: "WireAND2_MUX4to1", relPath: "ANDWire2" },
    { id: "WireAND3_MUX4to1", relPath: "ANDWire3" },
    { id: "WireOut_MUX4to1", relPath: "out" }
];
...
const SVG_WIDTH = 1107;
const SVG_HEIGHT = 736;

export default function MUX4to1View({ basePath = "regDstMux", onBack }) {
